...
namespace Tgyka.Microservice.OrderService.Infrastructure.Repositories
{
    ...
    {
        public OrderItemRepository(MssqlDbContext dbContext, IUnitOfWork unitofWork, IMapper mapper, TokenUser tokenUser) : base(dbContext, unitofWork, mapper, tokenUser)
        {
        }
    }
}
